...
async def add_student_laboratory(new_student_laboratory: Annotated[StudentLaboratoryCreate, Depends()], session: AsyncSession = Depends(get_async_session)):
    stmt = insert(student_laboratory).values(**new_student_laboratory.dict())
